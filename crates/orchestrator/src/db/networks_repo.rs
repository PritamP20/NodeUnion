...
pub async fn create_network(pool: &DbPool, network: &NetworkRow) -> Result<()> {
    sqlx::query(
        r#"
        INSERT INTO networks (network_id, name, description, orchestrator_url, status, created_at_epoch_secs)
        VALUES ($1, $2, $3, $4, $5, $6)
