...
export const comparisonRows: ComparisonRow[] = [
  {
    vendor: "NodeUnion",
    costPerHour: "$0.00 when idle, paid in SOL when busy",
    setupTime: "3 min",
    idleCost: "None",
...
export const flowSteps: FlowStep[] = [
  ...
  { title: "SOL Paid", description: "Provider receives settlement when usage is finalized." },
];

export const testimonialCards: QuoteCard[] = [
  {
    quote:
      "My workstation went from idle noise to steady SOL. I finally have a clean way to monetize spare GPU hours.",
    author: "Mara Chen",
...
export const tickerStats = [
  ...
  { label: "SOL paid out", value: "18,420" },
];
...
export const providerSummary = {
  totalEarned: "184.6 SOL",
  earnedMonth: "37.1 SOL",
  pendingSettlement: "8.9 SOL",
  uptime: "99.3%",
  jobsCompleted: 148,
  rejectionRate: "1.2%",
};
...
export const docSections: DocSection[] = [
  {
    ...
    steps: [
      "Install Rust stable, Node.js 20+, Docker, Solana CLI, Anchor CLI, and PostgreSQL.",
    ...
    callout: {
      ...
      body: "The current stack is intended for dev/test today: orchestrator on 8080, agent on 8090, dashboard on 3000, and Solana billing on devnet.",
    },
  },
  {
    id: "solana-program",
    group: "Orchestrator Setup",
    title: "Deploy the Solana billing program",
    summary: "Build and deploy the Anchor program on devnet, then wire the program ID into orchestrator config.",
    steps: [
      "Switch Solana CLI to devnet.",
      "Airdrop test SOL for the payer wallet.",
      "Build and deploy the Anchor workspace.",
      "Copy the deployed program ID into SOLANA_PROGRAM_ID.",
    ],
    codeBlocks: [
      {
        label: "Devnet deploy",
    ...
    callout: {
      tone: "tip",
      title: "Keep the payer funded",
      body: "Billing settlement and registration flows will fail if the payer wallet is out of devnet SOL or the program ID does not match the deployed Anchor artifact.",
    },
  },
  {
    ...
    steps: [
      "Set DATABASE_URL, SOLANA_RPC_URL, payer keypair, and single-network metadata.",
  ...
  {
    id: "solana-billing",
    group: "Solana Billing",
    title: "Credits, entitlements, and payout flow",
    summary: "User entitlements are tracked in PostgreSQL and usage settles on-chain through the billing program.",
    steps: [
