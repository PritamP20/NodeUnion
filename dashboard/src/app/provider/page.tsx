        ...
        <article className="glass-card rounded-[1.75rem] p-6">
          ...
          <form onSubmit={onSubmit} className="grid gap-4">
            <label className="text-sm text-slate-300">
              Wallet
              <input value={wallet} onChange={(e) => setWallet(e.target.value)} className="mt-1 w-full rounded-xl border border-white/10 bg-black/30 px-3 py-2" placeholder="stellar wallet address" />
            </label>
