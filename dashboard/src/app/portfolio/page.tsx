...
export default function PortfolioPage() {
    ...
    return snapshot.jobs
      ...
      .map((job) => {
        ...
        return {
          ...
          solEarned: formatXlm(solEstimate),
        };
      });
  ...
  const providerSummaryLive = useMemo(() => {
    ...
    return {
      totalEarned: formatXlm(totalCredits / 100),
      earnedMonth: formatXlm(monthCredits / 100),
      pendingSettlement: formatXlm(runningJobs.reduce((sum, job) => sum + estimateJobCredits(job), 0) / 100),
  ...
  const userSummaryLive = useMemo(() => {
    ...
    return {
      ...
      spentMonth: formatXlm(monthSpendTokens / 1_000_000_000),
      totalSpend: formatXlm(totalSpendTokens / 1_000_000_000),
    };
  ...
  const providerView = (
    <section className="mt-6 space-y-6">
      <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
        <MiniStatCard label="Total XLM earned" value={providerSummaryLive.totalEarned} icon={CircleDollarSign} />
      ...
      <div className="grid gap-6 xl:grid-cols-[1.1fr_0.9fr]">
        <article className="glass-card rounded-[1.75rem] p-6">
          ...
          <h2 className="mt-3 text-2xl font-semibold tracking-tight">XLM earned over the last 30 days</h2>
            ...
            <table className="min-w-full text-left text-sm">
              <thead className="bg-white/5 text-slate-400">
                <tr>
                  ...
                  <th className="px-4 py-3 font-medium">XLM earned</th>
                </tr>
              </thead>
              <tbody>
